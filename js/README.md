...
# OpenTok JS SDK Wrapper<br/>Version 1.0.0
...
*Without a bundler, you'll need to add the `browser` version of the `sdk-wrapper` to your project so that the `OpenTokSDK` constructor is available in `global` scope*:
```html
